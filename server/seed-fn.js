...
export function seed() {
  ...
  db.prepare(
    ...
    JSON.stringify([
      {
        asset: "CL (WTI Crude)",
        direction: "long",
        mechanism: "Supply disruption → price spike",
      },
      {
        asset: "XLE (Energy ETF)",
        direction: "long",
        mechanism: "Energy equities benefit from higher oil",
      },
      {
        asset: "EWJ (Japan ETF)",
        direction: "short",
        mechanism: "Energy import dependence → currency/equity pressure",
      },
      {
        asset: "USO (Oil ETF)",
        direction: "long",
        mechanism: "Direct oil exposure",
      },
    ]),
    JSON.stringify({
      start: "2026-03-15",
      end: "2026-06-30",
      basis: "Escalation cycle typically resolves or escalates within 90 days",
    }),
    0.15,
    0.45,
    0.25,
    JSON.stringify({
      description:
        "Crude vol curve is relatively flat. OTM calls on CL are cheap relative to the tail risk. Market is pricing ~10% disruption probability, I estimate 15-25%.",
      implied_prob: "0.10",
      gap_size: "moderate",
    }),
    JSON.stringify([
    ...
    JSON.stringify([
      {
        indicator: "Tanker insurance rates for Hormuz transit",
        current_state: "Elevated but not extreme",
        target_state: "Spike >3x baseline",
      },
      {
        indicator: "Iranian naval activity in the Gulf",
        current_state: "Increased patrols",
        target_state: "Live interdiction attempts",
      },
      {
        indicator: "Crude options implied volatility",
        current_state: "Moderate",
        target_state: "Sharp spike in OTM calls",
      },
    ]),
    JSON.stringify([
      {
        indicator: "Actual tanker rerouting away from Hormuz",
        current_state: "Minimal",
        target_state: "Significant rerouting",
      },
      {
        indicator: "Physical crude spot premium over futures",
        current_state: "Slight backwardation",
        target_state: "Sharp backwardation",
      },
    ]),
    JSON.stringify([
      {
        indicator: "Iran-Israel diplomatic breakthrough",
        current_state: "No talks",
        target_state: "Formal ceasefire/talks",
      },
      {
        indicator: "US naval presence drawdown in Gulf",
  ...
  db.prepare(
    ...
    JSON.stringify([
      {
        asset: "USD/JPY",
        direction: "short",
        mechanism: "JPY strengthens on policy normalization",
      },
      {
        asset: "EWJ (Japan ETF)",
        direction: "short",
        mechanism: "Strong yen hurts exporters initially",
      },
      {
        asset: "TLT (US Treasuries)",
        direction: "long",
        mechanism: "Carry trade unwind flows into safe havens",
      },
    ]),
    JSON.stringify({
      start: "2026-04-01",
      end: "2026-07-31",
      basis: "BoJ meetings in April and June are key decision points",
    }),
    0.2,
    0.5,
    0.35,
    JSON.stringify({
      description:
        "Market is pricing gradual normalization over 12+ months. I think the timeline could compress to 3-6 months.",
      implied_prob: "0.15",
    ...
    JSON.stringify([
      {
        indicator: "Japanese CPI trajectory",
        current_state: "Above target",
        target_state: "Above target and accelerating",
      },
    ]),
    JSON.stringify([
      {
        indicator: "BoJ forward guidance language shift",
        current_state: "Cautiously hawkish",
        target_state: "Explicitly hawkish",
      },
    ]),
    JSON.stringify([
      {
        indicator: "Japanese CPI falls below target",
        current_state: "Above target",
        target_state: "Below 2%",
      },
    ]),
    JSON.stringify([
  ...
  const signalData = [
    {
      ...
      title: "Iranian IRGC naval exercises in Strait of Hormuz",
      description:
        "IRGC announced 3-day naval exercise including fast-boat drills near Hormuz shipping lanes. Larger scale than typical quarterly exercises.",
      ...
      thesis_id: thesis1Id,
      status: "linked",
      source_attribution: "Reuters",
    },
    {
      category: "shipping_disruption",
      title: "Tanker insurance rates up 40% for Gulf routes",
      description:
        "War risk premiums for tankers transiting the Strait of Hormuz have increased 40% in the past 2 weeks according to Lloyd's market data.",
      ...
      thesis_id: thesis1Id,
      status: "linked",
      source_attribution: "Lloyd's List",
    },
    {
      category: "geopolitical_escalation",
      title: "US repositions carrier strike group to Persian Gulf",
      description:
        "USS Eisenhower CSG ordered to Persian Gulf from Mediterranean. Second carrier group in AOR in 6 months.",
      ...
      thesis_id: thesis1Id,
      status: "linked",
      source_attribution: "US CENTCOM press release",
    },
    {
      category: "energy_bottleneck",
      title: "Houthi anti-ship missile hits tanker near Bab el-Mandeb",
      description:
        "Greek-flagged tanker hit by anti-ship missile in Bab el-Mandeb strait. Minor damage, crew safe. Third incident this month.",
      source_type: "news_feed",
      novelty: "developing",
      reliability: "verified",
      signal_strength: 0.7,
      thesis_id: thesis1Id,
      status: "linked",
      source_attribution: "UKMTO / AP",
    },
    {
      category: "market_complacency",
      title: "Crude oil implied vol at 3-month low despite escalation",
      description:
        "WTI 30-day implied volatility has dropped to 3-month lows even as Middle East tensions escalate. Disconnect between geopolitical risk and market pricing.",
      source_type: "market_data",
      novelty: "new",
      reliability: "verified",
      signal_strength: 0.9,
      thesis_id: thesis1Id,
      status: "linked",
      source_attribution: "Bloomberg Terminal",
    },
    {
      category: "central_bank_action",
      title: "BoJ Governor Ueda signals openness to faster normalization",
      description:
        'In Diet testimony, Ueda stated that if inflation expectations become "firmly anchored," the pace of normalization "could be adjusted." Subtly more hawkish than previous statements.',
      source_type: "government",
      novelty: "new",
      reliability: "verified",
      signal_strength: 0.6,
      thesis_id: thesis2Id,
      status: "linked",
      source_attribution: "BoJ official transcript",
    },
    {
      category: "currency_instability",
      title: "Japan CPI prints 3.2% YoY vs 2.9% expected",
      description:
        "Core CPI excluding fresh food came in above consensus. Fifth consecutive month above 3%. Political pressure on BoJ mounting.",
      source_type: "market_data",
      novelty: "new",
      reliability: "verified",
      signal_strength: 0.7,
      thesis_id: thesis2Id,
      status: "linked",
      source_attribution: "Japan Statistics Bureau",
    },
    {
      category: "policy_shock",
      title: "Japan ruling party signals concern over yen weakness",
      description:
        'Senior LDP members publicly called on BoJ to "consider the burden on households from imported inflation." Unusual direct political pressure.',
      source_type: "news_feed",
      novelty: "new",
      reliability: "likely",
      signal_strength: 0.5,
      thesis_id: thesis2Id,
      status: "linked",
      source_attribution: "Nikkei",
    },
    {
      category: "commodity_chokepoint",
      title:
        "Yemen conflict intensifies — new drone swarm attacks on Red Sea shipping",
      description:
        "Houthi forces deploy coordinated drone swarm attack against commercial shipping in Red Sea. More sophisticated than previous attacks.",
      source_type: "news_feed",
      novelty: "new",
      reliability: "likely",
      signal_strength: 0.6,
      status: "inbox",
      source_attribution: "OSINT / Maritime tracking",
    },
    {
      category: "sanctions_risk",
      title: "EU discussing new sanctions package targeting Russian LNG",
      description:
        "Draft EU sanctions package reportedly includes restrictions on Russian LNG transshipment through European ports. Could affect 15% of European LNG supply.",
      source_type: "news_feed",
      novelty: "new",
      reliability: "unverified",
      signal_strength: 0.5,
      status: "inbox",
      source_attribution: "FT sources",
    },
  ];
  ...
  const obsData = [
    {
      ...
      data: {
        ...
        volume: 450000,
        timestamp: now,
        source_attribution: "Manual entry",
      },
    },
    {
      type: "price",
    ...
    },
    {
      ...
      data: {
        ...
        date: "2026-03-01",
        unit: "percent",
        source_attribution: "Federal Reserve",
      },
    },
    {
      type: "news",
      ...
      provider: "manual",
      data: {
        title: "Iran warns of retaliation if Israel strikes nuclear sites",
        url: "",
        source: "Reuters",
        publishedAt: now,
        source_attribution: "Reuters",
    ...
    },
    {
      ...
      data: {
        ...
        impact: "high",
        country: "JP",
        source_attribution: "BoJ Calendar",
      },
    },
    {
      type: "calendar_event",
      ...
      data: {
        ...
        impact: "high",
        country: "US",
        source_attribution: "Federal Reserve Calendar",
      },
    },
    {
      type: "sentiment",
      symbol: "CL",
      name: "Crude Oil Sentiment",
      provider: "manual",
      data: {
        sentiment: 0.35,
        description: "Moderately bullish positioning but low implied vol",
        source_attribution: "CFTC COT Report",
      },
    },
    {
      type: "volatility",
      symbol: "CL",
      name: "Crude Oil Implied Vol",
      provider: "manual",
      data: {
        impliedVol30d: 28.5,
        historicalVol30d: 32.1,
        ratio: 0.89,
        description: "IV below realized vol — potential underpricing of risk",
        source_attribution: "Options analytics",
      },
    },
  ];
  ...
  db.prepare(
    ...
    "binary",
    JSON.stringify(["iran", "hormuz", "oil", "geopolitics"]),
    now,
    now,
  );
  ...
  db.prepare(
    ...
    "2026-06-30T23:59:59Z",
    "binary",
    JSON.stringify(["oil", "energy", "commodities"]),
    now,
    now,
  );
  ...
  db.prepare(
    ...
    "binary",
    JSON.stringify(["japan", "boj", "rates", "macro"]),
    now,
    now,
  );
