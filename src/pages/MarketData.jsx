  ...
  return (
    <div className="p-6 max-w-6xl">
      <div className="flex justify-between items-start mb-6">
        <div>
          <h1 className="text-2xl font-bold text-slate-100">Market Context</h1>
          <p className="text-sm text-slate-500 mt-1">Macro backdrop for thesis validation. Data, not drama.</p>
        </div>
