...
export const api = {
  ...
  // LLM Advisory
  runAdvisoryEvaluation: (thesisId, options) => request(`/advisory/thesis/${thesisId}/evaluate`, {
    method: 'POST', body: JSON.stringify(options || {}),
  }),
  getLatestAdvisory: (thesisId) => request(`/advisory/thesis/${thesisId}/latest`),
  getAdvisoryHistory: (thesisId) => request(`/advisory/thesis/${thesisId}/history`),
